...
CREATE TABLE `user_warnings` (
  ...
  CONSTRAINT `user_warnings_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `Registr` (`id`),
  CONSTRAINT `user_warnings_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `Registr` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Дамп данных таблицы `user_warnings`
--
INSERT INTO `user_warnings` VALUES ('1', '12', '8', 'тмь', '2025-04-14 17:27:57', '2025-04-21 17:27:57');
INSERT INTO `user_warnings` VALUES ('2', '12', '8', 'раопа', '2025-04-14 17:28:01', '2025-04-21 17:28:01');
INSERT INTO `user_warnings` VALUES ('3', '12', '8', 'пьчпьп', '2025-04-14 17:28:03', '2025-04-21 17:28:03');
