...
<?php
try {
    $col_text = $db->query("SELECT * FROM col_text")->fetchAll(PDO::FETCH_ASSOC);
    $col_obyvn = $db->query("SELECT * FROM col_obyvn")->fetchAll(PDO::FETCH_ASSOC);
    $col_leg_promish = $db->query("SELECT * FROM col_leg_promish")->fetchAll(PDO::FETCH_ASSOC);
    $col_py14 = $db->query("SELECT * FROM col_py14")->fetchAll(PDO::FETCH_ASSOC);
    $col_istorya = $db->query("SELECT * FROM col_istorya")->fetchAll(PDO::FETCH_ASSOC);
...
$all_data = [
    'col_text' => $col_text,
    'col_obyvn' => $col_obyvn,
    'col_leg_promish' => $col_leg_promish,
    'col_py14' => $col_py14,
    'col_istorya' => $col_istorya
];
?>
...
<body>
    ...
    <header class="page-header">
        <div class="container">
            <h1>Исторические коллекции</h1>
            <p class="lead">Уникальные экспонаты и архивные материалы</p>
        </div>
    </header>
